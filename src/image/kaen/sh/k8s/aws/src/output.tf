...
output "manager_instance_count" {
  description = "This is a count of the AWS instances for the managers."
  value       = length(aws_instance.managers)
}
...
output "worker_instance_count" {
  description = "This is a count of the AWS instances for the workers."
